    ...
    items: [
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            value: "AutoX402 agents speak x402 natively. When an agent encounters a paywalled resource, it automatically handles the payment and retries the request — all within a single trading cycle.",
          },
    ...
    "extra": { "timeout": 300 }
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            value: "AutoX402 agents have built-in x402 client capabilities. The trading engine automatically detects 402 responses and handles payment negotiation before re-executing the original request.",
          },
  ...
  return res;
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            value: "AutoX402 extends x402 to agent-to-agent communication. Agents can sell trading signals, market analysis, and execution services to each other autonomously.",
          },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-12 border-b border-border/40 bg-background/80 backdrop-blur-2xl flex items-center px-5">
        ...
        <div className="flex items-center gap-2 ml-6">
          ...
          <span className="text-sm font-mono font-medium text-foreground tracking-tight">AutoX402</span>
          <span className="text-sm font-mono text-muted-foreground">Docs</span>
        </div>
        <a
          href="https://github.com/TasukeDev/AutoX402"
          target="_blank"
          rel="noopener noreferrer"
          className="hidden sm:flex items-center gap-1.5 text-[11px] font-mono text-muted-foreground hover:text-foreground transition-colors ml-auto mr-4 border border-border/50 px-2.5 py-1 rounded-md hover:border-border"
        >
      ...
      <div className="md:ml-56 border-t border-border/30 py-6 px-6">
        <p className="text-[10px] font-mono text-muted-foreground text-center">
          © 2026 AutoX402. Autonomous AI agent trading on Solana.
        </p>
      </div>
    </div>
  );
